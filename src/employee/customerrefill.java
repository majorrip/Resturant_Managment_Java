...
public class customerrefill {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    customerrefill window = new customerrefill();
    ...
    private void initialize() {
        ...
        frmTheCoronaCanteen.setIconImage(Toolkit.getDefaultToolkit().getImage(customerrefill.class.getResource("/employee/imageee.png")));
        ...
        JLabel lblAuthenticate = new JLabel("Add 500 to current account :");
        ...
        lblAuthenticate.setBounds(45, 233, 284, 38);
        ...
        btnAdd.setBounds(408, 245, 135, 23);
        frmTheCoronaCanteen.getContentPane().add(btnAdd);
